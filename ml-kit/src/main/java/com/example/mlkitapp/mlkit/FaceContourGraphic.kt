...
import com.example.mlkitapp.mlkit.GraphicOverlay.Graphic
...
class FaceContourGraphic(overlay: GraphicOverlay) : Graphic(overlay) {
    ...
    /**
     * Updates the face instance from the detection ofF the most recent frame. Invalidates the relevant
